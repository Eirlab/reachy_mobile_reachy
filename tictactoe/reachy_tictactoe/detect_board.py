"""
Detect board using Hough transform and perform classification in each case
"""
...
def find_board(board_img):
    """
    Find the board in the image using Hough algorithm
    :param board_img: the image of the board
    :return: the vertical and horizontal lines
    """
...
def find_board_cases(board_img):
    """
    Find the cases of the board
    :param board_img: the image of the board
    :return: a 3x3 array of the cases
    """
...
def get_board_cases(board_img):
    """
    Get the cases of the board
    :param board_img: the image of the board
    :return: a 3x3 array of the cases
    """
    ly, ry, lx, rx = 325, 700, 275, 710
    board_img = board_img[ly:ry, lx:rx, :]
    cases = find_board_cases(board_img)
    for row in range(3):
        for col in range(3):
